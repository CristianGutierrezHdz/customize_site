...
@section('content')
    <section>
        <div class="h-[530px] w-auto bg-blue-950 relative">
            <div class="h-[310px]">
                <div class="h-full bg-cover bg-center bg-[url('resources/web/images/mobile-bbva.png')]"></div>
            </div>
            ...
            <div class="h-60 w-screen bg-green-100 flex">
                <div class="h-full w-[100%] bg-green-100">
                    <div class="px-16 py-10">
                        ...
                        <h1 class="pb-2 font-light">Mantener tu información actualizada nos permite emitir tus comprobantes
