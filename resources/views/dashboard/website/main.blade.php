        ...
        <div class="h-60 w-screen bg-green-100 flex">
            <div class="h-full w-[100%] bg-green-100">
                <div class="px-16 py-10">
                    ...
                    <h1 class="pb-2 font-light">Mantener tu información actualizada nos permite emitir tus
                        comprobantes
                        CFDI con validez fiscal, lo que significa que tus facturas electrónicas seguirán siendo
                        deducibles de impuestos.</h1>
                    <button class="border-x-[20px] border-y-2 p-2 border-blue-500 bg-blue-500 text-white font-semibold">
                        Conoce cómo hacerlo </button>
                </div>
            </div>
            ...
            <div class="h-full w-[100%] bg-green-100">
                <div class="pl-16 py-10 flex gap-2">
                    ...
                    <div class="text-black">
                        ...
                        <h1 class="pb-2">Con la última actualización de tu app BBVA tienes lo que ya conoces y
                            más,
                            solo te tomará unos minutos actualizarla</h1>
                        <div class="py-2.5">
                            <a class="flex" href="#">
                                <div class="relative h-5 w-5 mt-0.5 mr-3 bg-blue-500 rounded-full">
                                    <p class="absolute text-green-100 text-sm -mt-[0.5px] h-5 w-5 text-center">✓
                                    </p>
                                </div>
        ...
        <div class="mx-4 h-72 bg-sky-600 flex">
            <div class="h-full w-3/5 grid place-content-center">
                <div class="w-[340px] gap-4 grid grid-cols-1 text-neutral-100">
                    ...
                    <p class="text-base">
                        Puedes realizar operaciones bancarias estés donde estés, conectándote con BBVA desde tu
                        celular.
                    </p>
                </div>
            </div>
