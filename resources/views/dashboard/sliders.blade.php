    ...
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
        <div class="align-middle rounded-tl-lg rounded-tr-lg inline-block w-[136.25%] md:w-full py-4 overflow-hidden bg-azul-1 shadow-lg px-12">
            <div class="flex justify-between">
                ...
                <a href="{{ route('dashboard.sliders.crear') }}" class="border-2 border-negro bg-morado-1 rounded-lg px-3 py-2 text-azul-1 cursor-pointer hover:bg-morado-1/70">
                    Agregar Producto
                </a>
                        ...
                        @foreach ($sliders as $dato)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                    <form action="{{ route('dashboard.sliders.eliminar') }}" method="POST">
                                        @csrf
