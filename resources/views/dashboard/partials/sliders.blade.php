                            ...
                            <div class="text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div class="flex flex-col">
                                    <fieldset class="w-full space-y-1 text-gray-800">
                                        ...
                                        <div
                                            class="grid grid-flow-row auto-rows-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                        ...
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            <label class="ml-4 relative inline-flex cursor-pointer items-center">
                                                ...
                                                @else
                                                    ...
                                                    <label
                                                        class="flex items-center w-10 border border-black h-6 p-1 rounded-full cursor-pointer justify-end bg-black"
                                                        for="toggle_1">
